                ...
                <form enctype="multipart/form-data" action="<?php echo ACTION_ROOT;?>/purchase.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="supplier_id" id="supplier_id" class="form-control">
                            ...
                            ?>
                            <option <?php echo (array_key_exists('supplier_id',$oldValue) && $oldValue['supplier_id'] == $supplier['id']) ?"selected":null;?> value="<?php echo $supplier['id'];?>"><?php echo $supplier['name'];?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input name="purchase_date" type="date" id="purchase_date" class="form-control" value="<?php echo array_key_exists('purchase_date',$oldValue) ? $oldValue["purchase_date"]:null;?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <select name="product_id" id="product_id" class="form-control">
                            ...
                            foreach ($allProducts as $product){
                                ?>
                                <option <?php echo (array_key_exists('product_id',$oldValue) && $oldValue['supplier_id'] == $product['id']) ?"selected":null;?> value="<?php echo $product['id'];?>"><?php echo $product['product_name'];?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input name="quantity" type="text" id="quantity" placeholder="EX:5" class="form-control" value="<?php echo array_key_exists('quantity',$oldValue) ? $oldValue["quantity"]:null;?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="note" placeholder="write something about purchase" id="note" cols="30" rows="10" class="form-control"><?php echo array_key_exists('note',$oldValue) ? $oldValue["note"]:null;?></textarea>
                    </div>
